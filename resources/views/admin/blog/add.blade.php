        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-8 mt-3">
                    <form action="{{route('admin.blog.store')}}" id="addDriverForm" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="card-body pb-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="blog_writer_name" name="blog_writer_name" required>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="image" class="font-weight-bold">Blog Image <span class="text-danger">*</span></label>
