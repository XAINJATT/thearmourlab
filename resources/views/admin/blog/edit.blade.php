            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-md-8 mt-3">
                        <form action="{{ route('admin.blog.update') }}" id="addDriverForm" class="blogs_form" method="post"
                                ...
                                <div class="card-header" style="padding: 0.5rem 1.5rem">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                                        ...
                                        <button type="button" class="btn btn-secondary ml-auto"
                                            onclick="window.location.replace('{{ route('admin.blog') }}');">Back
                                        </button>
                                    </div>
                                </div>
                                <hr>
                                <div class="card-body pb-2">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="font-weight-bold text-black">Title <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="title"
                                                value="{{ $blogs->title }}" placeholder="Enter Title" required>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="blog_writer_name" class="font-weight-bold">Blog Writer Name <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="blog_writer_name"
                                                name="blog_writer_name" value="{{ $blogs->blog_writer_name }}" required>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6 mb-3 mt-5">
                                            ...
                                            <label class="form-control label-style" id="image_browse">
                                                ...
                                                <input type="file" class="input-style" name="image"
                                                    onchange="ReadUrl(this, 'image_preview', 'image_browse');">
                                            </label>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-end">
                                            <button type="button" class="btn btn-light px-4 py-2"
                                                onclick="window.location.href='{{ route('admin.blog') }}'">
                                                Cancel
                                            </button>
