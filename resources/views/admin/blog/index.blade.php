            ...
            <section class="py-5">
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-12">
                        <div class="card">
                            <div class="card-header row d-flex flex-wrap">
                                <h6 style="min-width:250px" class="text-uppercase mb-0 col-10">HERE ARE ALL BLOGS </h6>
                                <a style="min-width:250px" href="{{ route('admin.blog.create') }}" class="btn btn-primary col-2 float-right">Add New
                                    Blog</a>
                            </div>
