                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('admin.invoice.edit', $order->id) }}" class="text-primary fs-6 mr-1" data-toggle="tooltip" title="Edit">
  ...
  function DeleteOrder(userId) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          type: "POST",
          url: "{{ url('admin/invoice/delete') }}" + '/' + userId, // Pass the product parameter
          data: {
            _token: "{{ csrf_token() }}"
          },
