                                ...
                                <div class="well">
                                    ...
                                    <div class="row" style="width: 100%;">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <button class="btn btn-info" onclick="toggleSection()"
                                                style="float: right;">Order Status</button>
                                        </div>
                                    </div>
                                    <!-- </form> -->
                                </div>
                ...
                <div class="container padding-bottom-3x mb-1">
                    <div class="card mb-3">
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap justify-content-between py-3 px-2 bg-secondary">
                            <div class="w-100 text-center py-1 px-2"><span class="text-medium">General Stages</span>
                                (applicable to all services)</div>
                            <div class="w-100 text-center py-1 px-2"><span class="text-medium">Paint Protection</span> Film
                                Stages</div>
                            <div class="w-100 text-center py-1 px-2"><span class="text-medium">Ceramic Coating</span> Stages
                            </div>
                            <div class="w-100 text-center py-1 px-2"><span class="text-medium"> Window Tint</span> Stages
                            </div>
                                        ...
                                        <tbody>
                                                    ...
                                                    <ul class="list-unstyled ps-0 mb-0">
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                ...
                                                                Vehicle has arrived and is logged into our system. </p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Evaluating the vehicle's condition before any work begins.
                                                            </p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-0 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Ensuring the car's surface is clean and free of
                                                                contaminants.</p>
                                                        </li>
                                                    </ul>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="p-0 text-center">
                                                    <div class="custom-checkbox custom-control">
                                                        <input type="checkbox" data-checkboxes="mygroup"
                                                            class="custom-control-input" id="checkbox-4" checked>
                                                ...
                                                <td>
                                                    <ul class="list-unstyled ps-0 mb-0">
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Cutting the PPF to the vehicle's specific measurements and
                                                                aligning it for application. </p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Polishing the vehicle's surface to ensure an immaculate
                                                                finish beneath the PPF.</p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-0 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                        ...
                                                        <li>
                                                            <p class="text-muted mb-0 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Allowing time for the glue under the Ppf to solidify and dry
                                                                enough to go home.</p>
                                                        </li>
                                                    </ul>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="p-0 text-center">
                                                    <div class="custom-checkbox custom-control">
                                                        <input type="checkbox" data-checkboxes="mygroup"
                                                            class="custom-control-input" id="checkbox-5" checked>
                                                ...
                                                <td>
                                                    <ul class="list-unstyled ps-0 mb-0">
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Preparing the vehicle's surface for ceramic coating. </p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Correcting any imperfections in the paint before the ceramic
                                                                coating application.</p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-0 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Applying the ceramic coating to protect the vehicle's paint.
                                                            </p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-0 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Allowing time for the ceramic coating to bond with the
                                                                vehicle's surface or PPF.</p>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    <ul class="list-unstyled ps-0 mb-0">
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Measuring windows and cutting tint film accordingly. </p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Applying the tint to the vehicle's windows.</p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-0 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                ...
                                                <td>
                                                    <ul class="list-unstyled ps-0 mb-0">
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Checking the quality of the work, ensuring no imperfections.
                                                            </p>
                                                        </li>
                                                        <li>
                                                            <p class="text-muted mb-1 text-truncate"><i
                                                                    class="mdi mdi-circle-medium align-middle text-primary me-1"></i>
                                                                Vehicle is ready and waiting for the customer.</p>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
