            ...
            <div class="container py-5">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                <img src="{{ isset($users->profile_image) ? asset(@$users->profile_image) : asset('assets/img/avatars/1.png') }}"
                    ...
                    <div class="col-lg-8">
                        ...
                        <form action="{{ route('admin.profile.update') }}" id="addDriverForm" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="first_name"
                                                placeholder="Enter First Name" value="{{ @$users->first_name }}" required>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="last_name"
                                                placeholder="Enter Last Name" value="{{ @$users->last_name }}" required>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6 mb-3">
                                            <label for="profile_image" class="font-weight-bold">Profile Picture <span
                                                    class="text-danger">*</span>&nbsp;&nbsp;
                                                <a href="{{ @$users->profile_image }}"
                                                    download="{{ @$users->profile_image }}">
                                                    <i class="fas fa-download"></i>
                                                </a>
                                            </label>
                                            <img src="" alt="" class="picture-src"
                                                id="profile_image_preview" onclick="$(this).next().trigger('click')"
