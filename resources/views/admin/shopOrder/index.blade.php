              ...
              <table id="shop_order_table" class="table table-striped table-hover card-text">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('admin.shopOrder.view', $order->id) }}" class="text-primary fs-6 mr-1" data-toggle="tooltip" title="View">
  ...
  function DeleteShopOrder(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          type: "POST",
          url: "{{ url('admin/shop/order/delete') }}" + '/' + id, // Pass the product parameter
          data: {
            _token: "{{ csrf_token() }}"
          },
