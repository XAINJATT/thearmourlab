            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 mt-3">
                        <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" id="editTestimonialForm"
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-header" style="padding: 0.5rem 1.5rem">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                                        <h4 class="mb-3 mb-md-0">Testimonials > <span class="text-secondary">Edit
                                                Testimonial</span></h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <label for="message" class="font-weight-bold">Message <span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control" name="message" rows="3" required>{{ $testimonial->message }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6 mt-2">
                                            ...
                                            <img src="{{ asset('storage/' . $testimonial->profile_picture) }}"
                                                alt="" class="picture-src" id="profile_picture_preview"
                                                style="width: 60%;">
