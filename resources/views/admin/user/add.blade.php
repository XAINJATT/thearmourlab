        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-8 mt-3">
                    <form action="{{route('admin.user.store')}}" id="addDriverForm" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="card-body pb-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" id="-email-" placeholder="Enter Email" onchange="CheckForAdvanceDuplicateEmail('', this.value);" value="{{old('email')}}" required>
                                        <span class="error d-none duplicateEmailError" id="duplicateEmailError">Email address already exists!</span>
                                        @error('email')
