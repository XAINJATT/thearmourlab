                    ...
                    <div class="col-lg-12 mb-12">
                        <div class="card">
                            <div class="card-header row">
                                ...
                                <a href="{{ route('admin.user.create') }}" class="btn btn-primary col-2 float-right">Add New
                                    User</a>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($user->status == 0)
                                                        <button onclick="userStatus({{ $user->id }})">
        ...
        function userStatus(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('admin.user.statusUpdate', ['id' => ':id']) }}".replace(':id',
                            userId),
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
