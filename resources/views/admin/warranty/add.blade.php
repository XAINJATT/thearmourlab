                                ...
                                <div class="row py-sm-3">
                                    ...
                                    <table id="maintenanceLog">
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" type="text" name="annualInspection[]">
                                            </td>
                                            <td><input class="form-control" type="text" name="productUsed[]"></td>
                                            <td><input class="form-control" type="text" name="performedBy[]"></td>
                                            <td><input class="form-control" type="text" name="notes[]"></td>
                                            <td><button type="button" class="btn btn-success" onclick="addRow()">Add
                                                    Row</button></td>
                                        </tr>
                                    </table>
                                    ...
                                    <div class="col-md-6 col-12 mt-2">
                                        ...
                                        <div style="padding: 30px" class="row p-3">
                                            <div style="width: 100%">
                                                <canvas style="background: #dedede" id="signature-pad" width="400"
                                                    height="200"></canvas>
                                            </div>
