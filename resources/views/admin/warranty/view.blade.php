                                    ...
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="first_name" name="first_name"
                                                value="{{ @$warranty->user->first_name }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="last_name" name="last_name"
                                                value="{{ @$warranty->user->last_name }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="tel" name="tel"
                                                value="{{ @$warranty->user->phone }}" disabled />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="make" name="make"
                                                placeholder="Make" value="{{ @$warranty->make }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="model" name="model"
                                                placeholder="Model" value="{{ @$warranty->model }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="year" name="year"
                                                placeholder="Year" value="{{ @$warranty->year }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="colour" name="colour"
                                                value="{{ @$warranty->colour }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                    ...
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="exterior_package"
                                                name="exterior_package" value="{{ @$warranty->exterior_package }}"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="interior" name="interior"
                                                placeholder="Interior" value="{{ @$warranty->interior }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="windows" name="windows"
                                                placeholder="Windows" value="{{ @$warranty->windows }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="wheels" name="wheels"
                                                placeholder="Wheels" value="{{ @$warranty->wheels }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="trim" name="trim"
                                                placeholder="Trim" value="{{ @$warranty->trim }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="paint_correction"
                                                name="paint_correction" value="{{ @$warranty->paint_correction }}"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="body" name="body"
                                                placeholder="Body" value="{{ @$warranty->body }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="coating_duration"
                                                name="coating_duration" value="{{ @$warranty->coating_duration }}"
                                                disabled />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <label class="switch switch-primary me-0" style="margin-left: 30px;">
                                                <input type="checkbox" class="switch-input" id="full_front_end"
                                                    name="full_front_end" value="1"
                                                    {{ @$warranty->full_front_end ? 'checked' : '' }} disabled>
                                            </label>
                                        </div>
                                        <div class="col-4">
                                            ...
                                            <label class="switch switch-primary me-0" style="margin-left: 30px;">
                                                <input type="checkbox" class="switch-input" id="partial_front_end"
                                                    name="partial_front_end" value="1"
                                                    {{ @$warranty->partial_front_end ? 'checked' : '' }} disabled>
                                            </label>
                                        </div>
                                        <div class="col-4">
                                            ...
                                            <label class="switch switch-primary me-0" style="margin-left: 30px;">
                                                <input type="checkbox" class="switch-input" id="full_body"
                                                    name="full_body" value="1"
                                                    {{ @$warranty->full_body ? 'checked' : '' }} disabled>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="attitionl_panels"
                                                name="attitionl_panels" value="{{ @$warranty->attitionl_panels }}"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="ppf_brand" name="ppf_brand"
                                                placeholder="Ppf Brand" value="{{ @$warranty->ppf_brand }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="roll_serial_number"
                                                name="roll_serial_number" value="{{ @$warranty->roll_serial_number }}"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="warranty_duration"
                                                name="warranty_duration" value="{{ @$warranty->warranty_duration }}"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="installer" name="installer"
                                                placeholder="Installer" value="{{ @$warranty->installer }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mt-2">
                                        <div class="">
                                            ...
                                            <input type="date" class="form-control" id="date_of_installaction"
                                                ...
                                                value="{{ @$warranty->date_of_installation }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="container table-responsive my-3">
                                            <h4>Ceramic Coating Maintenance Log:</h4>
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>Date</th>
                                                ...
                                                <tbody>
                                                    @if ($warranty->log_data)
                                                        @php($logs = json_decode(@$warranty->log_data, true))
                                                    @else
                                                        @php($logs = [])
                                                    @endif
                                                    @forelse ($logs as $log)
