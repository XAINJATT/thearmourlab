            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-md-8 mt-3">
                        <form action="{{ route('admin.WorkOrderStatus.store') }}" id="addProductForm" method="post"
                                ...
                                <div class="card-header" style="padding: 0.5rem 1.5rem">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                                        ...
                                        <button type="button" class="btn btn-secondary ml-auto"
                                            onclick="window.location.replace('{{ route('admin.WorkOrderStatus') }}');">Back
                                        </button>
                                    </div>
                                </div>
                                <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-end">
                                            <button type="button" class="btn btn-light px-4 py-2"
                                                onclick="window.location.href='{{ route('admin.WorkOrderStatus') }}'">
                                                Cancel
                                            </button>
