...
<link rel="canonical" href="{{ route('frontend.blogDetails', ['id' => $blogDetails->id, 'slug' => \Str::slug($blogDetails->title)]) }}">

<meta property="og:type" content= "website" />
        <meta property="og:url" content="{{ route('frontend.blogDetails', ['id' => $blogDetails->id, 'slug' => \Str::slug($blogDetails->title)]) }}">
