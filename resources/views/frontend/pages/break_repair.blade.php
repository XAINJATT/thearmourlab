...
<div class="page-content bg-white">
	<!-- Inner Banner -->
    <div class="page-banner ovbl-dark" style="background-image:url(images/banner/bnr4.jpg);">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="ttr-media mb-30">
                        <img src="images/service-section/pic9.jpg" class="imghight" alt="">
                    </div>
                    <div class="mb-30">
                        <div class="head-text mb-30">
                            <h4 class="title mb-10">Industrial</h4>
                    ...
                    <div class="head-text mb-30">
                        <h4 class="title mb-10">WE CAN OFFER FOLLOWING TYPES OF SOLUTIONS:</h4>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="head-text mb-30">
                                <h4 class="title mb-10">SERVICES PROGRESS</h4>
                                <p class="mb-0">Standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>
                            </div>
