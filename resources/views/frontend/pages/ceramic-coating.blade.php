                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="ttr-media mb-30">
                                    <video autoplay style="height:70vh" loop muted class="mb-10" width="100%" src="{{asset("images/cc/Sequence 03.mov")}}"></video>
                                </div>
                            </div>
                            <div class="col-xl-6">
                            ...
                            <div class="tabs-wrapper">
                                <span class="left scroller-btn">
                                    <ul id="scroller" class="nav nav-tabs">
                                        <li style="min-width:150px" class="active mb-3" data-id="regular-size-car"
