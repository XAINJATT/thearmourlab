...
<!-- Mirrored from serfix.themetrades.com/html/demo/faq-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Sep 2023 16:14:09 GMT -->
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Serfix : Car Service And Dealership HTML Template </title>
...
<div class="page-wraper">
		...
		<div class="sticky-header navbar-expand-lg">
			<div class="menu-bar clearfix ">
				<div class="container clearfix">
					<!-- Website Logo -->
					<div class="menu-logo">
						<a href="index-2.html" class="main-logo"><img src="images/logo-white.png" alt=""></a>
						<a href="index-2.html" class="sticky-logo"><img src="images/logo.png" alt=""></a>
					</div>
					<!-- Nav Toggle -->
					...
					<div class="secondary-menu">
						...
						<a href="booking.html" class="btn btn-primary ms-3">Booking</a>
					</div>
					<!-- Menu Links -->
					<div class="menu-links navbar-collapse collapse justify-content-center" id="menuDropdown">
						...
						<ul class="nav navbar-nav">	
							<li class="active"><a href="javascript:;">Home<i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									<li><a href="index-2.html"><span>Home 1</span> </a></li>
									<li><a href="index-3.html"><span>Home 2</span></a></li>
								</ul>
							</li>
							<li class="has-mega-menu "><a href="javascript:;">Pages<i class="fa fa-chevron-down"></i></a>
								<ul class="mega-menu">
									<li>
										...
										<ul>
											<li><a href="about-1.html"><span>About Us 1</span></a></li>
											<li><a href="about-2.html"><span>About Us 2</span></a></li>
											<li><a href="service-1.html"><span>Service 1</span></a></li>
											<li><a href="service-2.html"><span>Service 2</span></a></li>
										</ul>
									</li>
									<li>
										<a href="javascript:;">Pages</a>
										<ul>
											...
											<li><a href="job-career.html"><span>Job & Career</span></a></li>
											<li><a href="faq-1.html"><span>FAQ's</span></a></li>
										</ul>
									</li>
									<li>
										<a href="javascript:;">Pages</a>
										<ul>
											...
											<li><a href="gallery-1.html"><span>Gallery 1</span></a></li>
											<li><a href="gallery-2.html"><span>Gallery 2</span></a></li>
									...
									<li>
										...
										<ul>
											...
											<li><a href="contact-1.html"><span>Contact Us 1</span></a></li>
											<li><a href="contact-2.html"><span>Contact Us 2</span></a></li>
										</ul>
									</li>
								</ul>
							</li>
							<li>
								...
								<ul class="sub-menu">
									<li class="add-menu-left">
										<ul>
											<li><a href="service-engine-diagnostics.html"><span>Engine Diagnostics</span> </a></li>
											<li><a href="service-lube-oil-and-filters.html"><span>Lube Oil and Filters</span></a></li>
											<li><a href="service-belts-and-hoses.html"><span>Belts and Hoses</span></a></li>
											<li><a href="service-air-conditioning.html"><span>Air Conditioning</span></a></li>
											<li><a href="service-brake-repair.html"><span>Brake Repair</span></a></li>
											<li><a href="service-tire-and-wheel-services.html"><span>Tire and Wheel Services</span></a></li>
										</ul>
									</li>
								</ul>
							</li>
							<li><a href="javascript:;">Blog <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu left">
									...
									<li><a href="blog-grid-sidebar.html"><span>Blog Grid Sidebar</span></a></li>
									<li><a href="blog-masonry.html"><span>Blog Masonry</span></a></li>
									<li><a href="blog-list-sidebar.html"><span>Blog List Sidebar</span></a></li>
	...
	<div class="page-content bg-white">
			...
			<div class="container">
				<div class="page-banner-entry text-center">
					...
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="index-2.html"><i class="las la-home"></i>Home</a></li>
		...
		<!-- Faq -->
		<section class="section-area section-sp3">
		   <div class="container">
				<div class="row">
					<div class="col-lg-6">
					...
					<div class="col-lg-6">
						<div class="ttr-accordion style1" id="themeAccordion2">
							<div class="card">
								<div class="card-header collapsed" id="headingSeven" role="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
									<i class="fa fa-question-circle"></i>
									What parts should be replaced at what intervals?
								</div>
								<div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-bs-parent="#themeAccordion2">
									<div class="card-body">
									Synthetic engine oils are produced through a synthesis process that takes very small molecules and assembles them into larger designer molecules with premium lubricating properties.
									</div>
								</div>
							...
							<div class="card">
								<div class="card-header collapsed" id="headingTen" role="button" data-bs-toggle="collapse" data-bs-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
									<i class="fa fa-question-circle"></i>
									What parts should be replaced at what intervals?
								</div>
								<div id="collapseTen" class="collapse" aria-labelledby="headingTen" data-bs-parent="#themeAccordion2">
									<div class="card-body">
									Synthetic engine oils are produced through a synthesis process that takes very small molecules and assembles them into larger designer molecules with premium lubricating properties.
									</div>
								</div>
							...
							<div class="card">
								<div class="card-header collapsed" id="headingEight" role="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
									<i class="fa fa-question-circle"></i>
									How do I keep track of routine maintenance?
								</div>
								<div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-bs-parent="#themeAccordion2">
									<div class="card-body">
									Synthetic engine oils are produced through a synthesis process that takes very small molecules and assembles them into larger designer molecules with premium lubricating properties.
									</div>
								</div>
							...
							<div class="card">
								<div class="card-header" id="headingSix" data-bs-toggle="collapse" role="button" data-bs-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
									<i class="fa fa-question-circle"></i>
									Should I consider using synthetic motor oil?
								</div>
								<div id="collapseSix" class="collapse show" aria-labelledby="headingSix" data-bs-parent="#themeAccordion2">
									<div class="card-body">
									Synthetic engine oils are produced through a synthesis process that takes very small molecules and assembles them into larger designer molecules with premium lubricating properties.
									</div>
								</div>
							...
							<div class="card">
								<div class="card-header collapsed" id="headingNine" role="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
									<i class="fa fa-question-circle"></i>
									Should I consider using synthetic motor oil?
								</div>
								<div id="collapseNine" class="collapse" aria-labelledby="headingNine" data-bs-parent="#themeAccordion2">
									<div class="card-body">
									Synthetic engine oils are produced through a synthesis process that takes very small molecules and assembles them into larger designer molecules with premium lubricating properties.
									</div>
								</div>
		...
		<section class="section-area section-sp1">
			<div class="container">
				<div class="heading-bx text-center">
					<h6 class="title-ext text-primary">No helpful answer</h6>
					<h2 class="title mb-0">HERE ARE SOME OPTION</h2>
				</div>
				<div class="row">
					<div class="col-md-6 mb-30">
						<div class="feature-container bg-gray-alt left feature-bx1">
							...
							<div class="icon-content ps-10">
								<h5 class="ttr-tilte">HELP DESK SUPPORT</h5>
					...
					<div class="col-md-6 mb-30">
						<div class="feature-container bg-gray-alt left feature-bx1">
							...
							<div class="icon-content ps-10">
								<h5 class="ttr-tilte">LIVE CHAT SUPPORT</h5>
								<p>There are many variations of passages of Lorem Ipsum available.</p>
								<a href="services-details.html" class="btn-link">Read More</a>
							</div>
						</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 text-center text-md-start">
						<p class="mb-0">© Copyright Serfix 2022. All right reserved.</p>
					</div>
...
<!-- Mirrored from serfix.themetrades.com/html/demo/faq-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Sep 2023 16:14:11 GMT -->
</html>