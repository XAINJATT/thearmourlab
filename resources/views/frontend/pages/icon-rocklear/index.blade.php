...
<html lang="en">
    ...
    <main>
              ...
              <div class="right">
                ...
                <div>
                  <div class="swiper swiperFirst">
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide">
                        <img
                          ...
                          width="1006"
                          height="646"
                          src="images/Agriculture-min.png"
                          class="attachment-full size-full"
                          alt=""
                          srcset="
                    ...
                    <div
                      class="d-flex align-items-center gap-5 swiper-controls"
                    >
                      ...
                      <div
                        class="swiper-pagination-first text-white w-auto"
                      ></div>
          ...
          <div class="flex">
            <div class="column">
              <img
                ...
                width="562"
                height="384"
                src="images/oRANGE-TRUCK.png"
                class="attachment-large size-large wp-image-1416"
                alt=""
                srcset="
              ...
              <div class="progress-bar-container">
                ...
                <div class="progress-image">
                  <img
                    ...
                    class="attachment-large size-large wp-image-433"
                    alt=""
                    srcset="
              ...
              <div class="progress-bar-container">
                ...
                <div class="progress-image">
                  <img
                    ...
                    class="attachment-large size-large wp-image-449"
                    alt=""
                    srcset="
        ...
        <div class="section-container">
          <div class="">
            <div class="customTab-custom">
              <div>
                <div
                  class="my-custom-customTabs d-flex justify-content-between w-100 bg-white"
                >
                  <button
                    class="customTab cta-btns cta-primary"
                    data-customTab="Guaranteed"
                  >
                    GUARANTEED
                  </button>
                  ...
                  <div class="col-md-12 col-lg-6">
                    <div class="image-area">
                      <img
                        ...
                        class="attachment-large img-fluid size-large wp-image-1006"
                        alt=""
                        srcset="
                  ...
                  <div class="col-md-12 col-lg-6">
                    <div class="image-area">
                      <img
                        ...
                        class="attachment-large size-large wp-image-1012"
                        alt=""
                        srcset="
                  ...
                  <div class="col-md-12 col-lg-6">
                    <div class="image-area">
                      <img
                        ...
                        class="attachment-large size-large wp-image-1008"
                        alt=""
                        srcset="
                  ...
                  <div class="col-md-12 col-lg-6">
                    <div class="image-area">
                      <img
                        ...
                        class="attachment-large size-large wp-image-1010"
                        alt=""
                        srcset="
      ...
      <section class="section-9 mb-5">
        <div class="section-container text-center mt-5 pt-3">
          ...
          <div id="image-compare" class="image-compare-container">
            <img
              loading="lazy"
              decoding="async"
              width="1500"
              height="800"
              src="images/Correction.png"
              class="attachment-full size-full wp-image-1022 icv__img icv__img-a"
              alt=""
              srcset="
                images/Correction.png          1500w,
                images/Correction-300x160.png   300w,
                images/Correction-1024x546.png 1024w,
                images/Correction-768x410.png   768w
              "
            ...
            <img
              ...
              class="attachment-full size-full wp-image-1023 icv__img icv__img-b"
              alt=""
              srcset="
                images/PROTECTION.png          1500w,
                images/PROTECTION-300x160.png   300w,
                images/PROTECTION-1024x546.png 1024w,
                images/PROTECTION-768x410.png   768w
              "
              sizes="(max-width: 1500px) 100vw, 1500px"
            />
          </div>
      ...
      <section class="section-10 mt-5">
        <div class="section-container">
          ...
          <div class="row h-100">
            <div
              class="col-lg-4 col-md-12 justify-content-between d-flex flex-column"
            >
              <div class="text-center">
                <h5 class="fw-bolder">
                  ...
                  <div class="card">
                    <div class="card-body pb-2">
                      <img
                        class="img-fluid"
                        width="80"
                        src="images/Vector-Smart-Object-3.png"
                        alt=""
                      />
                  ...
                  <div class="card">
                    <div class="card-body pb-2">
                      <img
                        class="img-fluid"
                        width="80"
                        src="images/Vector-Smart-Object411.png"
                        alt=""
                      />
                      <h6 class="mt-3">
                        20X UV <br />
                  ...
                  <div class="card">
                    <div class="card-body pb-2">
                      <img
                        class="img-fluid"
                        width="80"
                        src="images/guarantee-certificate1.png"
                        alt=""
                      />
                      <h6 class="mt-3">
                  ...
                  <div class="card">
                    <div class="card-body pb-2">
                      <img
                        class="img-fluid"
                        width="80"
                        src="images/Vector-Smart-Object-4.png"
                        alt=""
                      />
                      <h6 class="mt-3">
                        35X THICKER <br />
                  ...
                  <div class="card">
                    <div class="card-body pb-2">
                      <img
                        class="img-fluid"
                        width="80"
                        src="images/Vector-Smart-Object-5.png"
                        alt=""
                      />
      ...
      <section class="section-11">
        <div class="section-container">
          ...
          <div class="row">
            <div class="col-lg-5 iframe-container">
              <iframe
                class="elementor-video"
                frameborder="0"
                allowfullscreen=""
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                title="Icon Rocklear Protection and Correction"
                width="440"
                height="360"
        ...
        <div class="section-container">
          ...
          <div class="row gap-3">
            ...
            <div class="col-sm-12 col-md-12 col-lg-3">
              <img
                class="img-fluid"
                src="images/Screenshot-at-Aug-27-15-57-43.png"
                alt=""
              />
            </div>
          </div>
      ...
      <section class="section-17">
        ...
        <div #swiperRef="" class="swiper mySwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img
                src="images/image_6487327-scaled.jpg"
                alt="Image Description"
              />
            </div>
            <div class="swiper-slide">
              <img
                src="images/image_6487327-2-scaled.jpg"
                alt="Image Description"
              />
            </div>
            <div class="swiper-slide">
              <img
                src="images/image_6483441-scaled.jpg"
                alt="Image Description"
              />
            </div>
            <div class="swiper-slide">
              <img
                src="images/image_6487327-3-scaled.jpg"
                alt="Image Description"
              />
            </div>
          </div>
      ...
      <section class="section-20 py-5 mt-5">
        <div class="section-container py-5 mt-5">
          <div
            class="d-flex gap-4 pt-3 flex-column align-items-center justify-content-center"
          >
              ...
              <div class="card">
                <div class="card-body text-center py-5">
                  ...
                  <img
                    ...
                    width="330"
                    height="3"
                    src="images/Rectangle-10-copy-1.png"
  ...
  <script>
    var progressBars = {
      rocklear: [
        { label: "SCRATCH RESISTANCE", value: 100, maxValue: 100 },
        { label: "COLOR ENHANCEMENT", value: 100, maxValue: 100 },
        { label: "FEATURE CLARITY", value: 100, maxValue: 100 },
        { label: "COATING THICKNESS (UM+)", value: 35, maxValue: 35 },
        { label: "UV PROTECTION", value: 100, maxValue: 100 },
        { label: "ROCK CHIP RESISTANCE", value: 40, maxValue: 100 },
        { label: "CHEMICAL PROTECTION", value: 100, maxValue: 100 },
        { label: "SALT SPRAY", value: 100, maxValue: 100 },
        { label: "IMPACT ABSORPTION (IN LBS)", value: 120, maxValue: 100 }, // Note: The value here is above the maxValue.
        { label: "FLEXIBILITY", value: 100, maxValue: 100 },
        { label: "LONGEVITY", value: 100, maxValue: 100 },
        { label: "WARRANTY", value: 100, maxValue: 100 },
        { label: "DURABILITY", value: 100, maxValue: 100 },
        { label: "CLEAR COAT REDUCTION", value: 5, maxValue: 100 },
        { label: "YEARLY RECOATS COSTS", value: 0, maxValue: 100 },
        { label: "MANDATORY MAINTENANCE", value: 0, maxValue: 100 },
      ],
      ceramic: [
        { label: "SCRATCH RESISTANCE", value: 10, maxValue: 100 },
        { label: "COLOR ENHANCEMENT", value: 60, maxValue: 100 },
        { label: "FEATURE CLARITY", value: 30, maxValue: 100 },
        { label: "COATING THICKNESS (UM+)", value: 2.5, maxValue: 35 },
        { label: "UV PROTECTION", value: 50, maxValue: 100 },
        { label: "ROCK CHIP RESISTANCE", value: 0, maxValue: 100 },
        { label: "CHEMICAL PROTECTION", value: 10, maxValue: 100 },
        { label: "SALT SPRAY", value: 30, maxValue: 100 },
        { label: "IMPACT ABSORPTION (IN LBS)", value: 80, maxValue: 100 },
        { label: "FLEXIBILITY", value: 100, maxValue: 100 },
        { label: "LONGEVITY", value: 25, maxValue: 100 },
        { label: "WARRANTY", value: 25, maxValue: 100 },
        { label: "DURABILITY", value: 20, maxValue: 100 },
        { label: "CLEAR COAT REDUCTION", value: 60, maxValue: 100 },
        { label: "YEARLY RECOATS COSTS", value: 100, maxValue: 100 },
        { label: "MANDATORY MAINTENANCE", value: 100, maxValue: 100 },
      ],
      polymers: [
        { label: "SCRATCH RESISTANCE", value: 0, maxValue: 100 },
        { label: "COLOR ENHANCEMENT", value: 20, maxValue: 100 },
        { label: "FEATURE CLARITY", value: 15, maxValue: 100 },
        { label: "COATING THICKNESS", value: 0, maxValue: 35 },
        { label: "UV PROTECTION", value: 15, maxValue: 100 },
        { label: "ROCK CHIP RESISTANCE", value: 0, maxValue: 100 },
        { label: "CHEMICAL PROTECTION", value: 0, maxValue: 100 },
        { label: "SALT SPRAY", value: 0, maxValue: 100 },
        { label: "IMPACT ABSORPTION", value: 0, maxValue: 100 },
        { label: "FLEXIBILITY", value: 0, maxValue: 100 },
        { label: "LONGEVITY", value: 5, maxValue: 100 },
        { label: "WARRANTY", value: 0, maxValue: 100 },
        { label: "DURABILITY", value: 0, maxValue: 100 },
        { label: "CLEAR COAT REDUCTION", value: 0, maxValue: 100 },
        { label: "YEARLY RECOATS COSTS", value: 100, maxValue: 100 },
        { label: "MANDATORY MAINTENANCE", value: 100, maxValue: 100 },
      ],
    };
    ...
    var cards = [
      {
        ...
        imgSrcset:
          "images/Strentgth.png 407w, images/Strentgth-300x148.png 300w",
      ...
      },
      {
        ...
        imgSrcset:
          "images/Brilance-1.png 407w, images/Brilance-1-300x148.png 300w",
        imgSizes: "(max-width: 407px) 100vw, 407px",
        title: "30%+ BRILLIANCE",
      ...
      },
      {
        ...
        imgSrcset:
          "images/Impact-resistance.png 407w, images/Impact-resistance-300x148.png 300w",
        imgSizes: "(max-width: 407px) 100vw, 407px",
      ...
      },
      {
        ...
        imgSrcset:
          "images/car-adhesion.png 407w, images/car-adhesion-300x148.png 300w",
        imgSizes: "(max-width: 407px) 100vw, 407px",
        title: "ADHESION",
      ...
      },
      {
        ...
        imgSrcset:
          "images/renewable.png 407w, images/renewable-300x148.png 300w",
        imgSizes: "(max-width: 407px) 100vw, 407px",
        title: "RENEWABLE",
      ...
      },
      {
        ...
        imgSrcset:
          "images/mandrel-bend-car.png 407w, images/mandrel-bend-car-300x148.png 300w",
        imgSizes: "(max-width: 407px) 100vw, 407px",
        title: "MANDREL BEND",
      ...
      },
      {
        ...
        imgSrcset:
          "images/maintance.png 407w, images/maintance-300x148.png 300w",
        imgSizes: "(max-width: 407px) 100vw, 407px",
        title: "MAINTENANCE",
