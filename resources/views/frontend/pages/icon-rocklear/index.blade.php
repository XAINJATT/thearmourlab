...
@section('content')
    <main>
        ...
        <nav aria-label="breadcrumb">
            <ol>
                <li><a href="/" class="visually-hidden">Home</a></li>
                <li><a aria-current="page" class="visually-hidden">Icon Rocklear</a></li>
            </ol>
        </nav>
            ...
            <div class="section-1-container">
                @if (request('thankyou'))
                    <div class="alert alert-success" style="background:#0d9344">
                        ...
                        <h6 style="text-align: center" class="text-center">For faster service or to book your appointment
                            please call <a href="tel:+416-675-6853">416-675-6853</a></h6>
                    </div>
                @endif
