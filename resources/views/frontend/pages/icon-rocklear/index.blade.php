...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('icon_rocklear/css/style.css?v=11adfffgf') }}" />
@endsection
        ...
        <section class="section-9 mb-5">
            <div class="section-container text-center mt-5 pt-3">
                ...
                <div id="image-compare" class="image-compare-container">
                    <img loading="lazy" decoding="async" width="1500" height="800" src="images/Correction.png"
                        class="attachment-full size-full wp-image-1022 icv__img icv__img-a" alt=""
                        srcset="
              ...
              "
                    ...
                    <img loading="lazy" decoding="async" width="1500" height="800" src="images/PROTECTION.png"
                        class="attachment-full size-full wp-image-1023 icv__img icv__img-b" alt=""
                        srcset="
...
@section('scripts')
    ...
    <script src="js/script.js?v=1asdtesting2if"></script>
@endsection
