                                    ...
                                    <div id="tint_simulator_auto_intro" class="tint-simulator-auto-intro" data-cms-area="tint_simulator_auto_intro_en_US" data-cms-area-filters="path">
                                        <div>
                                            <div data-view="CCT-View" data-cms-cct-instanceid="CMS_HTML-388" class="cms-content cms-content-CMS_HTML cms-content-selector-CMS_HTML-388">
                                                <div>
                                                    <h1 class="simulator-title">Paint Protection Film</h1>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function updateBaseImage() {
            ...
            base.css("background-image", "url(web-assets/simulators/paint_protection_images/" + currentType + "-" + currentColor + ".jpg)");
        }
        ...
        function updateProductImages(currentPositionChange, currentTint) {
            ...
            var productImageFrontURL = "web-assets/simulators/paint_protection_images/tints/" + selectedType + "-" + currentFrontPosition + "-" + currentTint + ".png";
            var productImageSidesURL = "web-assets/simulators/paint_protection_images/tints/" + selectedType + "-" + currentSidesPosition + "-" + currentTint + ".png";
            var productImageBackURL = "web-assets/simulators/paint_protection_images/tints/" + selectedType + "-" + currentBackPosition + "-" + currentTint + ".png";
            var productImageWindshieldURL = "web-assets/simulators/paint_protection_images/tints/" + selectedType + "-" + currentWindshieldPosition + "-" + currentTint + ".png";
