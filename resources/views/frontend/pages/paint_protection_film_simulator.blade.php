                                ...
                                <div class="pricingtable-inner">
                                    <div class="pricingtable-main">
                                        <div class="pricingtable-price">
                                            <img class="img-fluid w-100" src="{{ asset('images/BRONZE.png') }}" alt="">
                        ...
                        <div class="col-xl-3 col-sm-6 mb-30">
                            <div class="pricingtable-wrapper style1 ">
                                ...
                                <div class="pricingtable-inner">
                                    <div class="pricingtable-main">
                                        <div class="pricingtable-price">
                                            <img class="img-fluid w-100" src="{{ asset('images/SILVER.png') }}" alt="">
                                            <span>Starting From</span><br>
                                            <div class="text-center">
                                                <span class="priceing-doller">$</span>
                        ...
                        <div class="col-xl-3 col-sm-6 mb-30">
                            <div class="pricingtable-wrapper style1 pricingtable-highlight">
                                ...
                                <div class="pricingtable-inner">
                                    <div class="pricingtable-main">
                                        <div class="pricingtable-price">
                                            <img class="img-fluid w-100" src="{{ asset('images/GOLD.png') }}" alt="">
                                            <span>Starting From</span><br>
                                            <div class="text-center">
                                                <span class="priceing-doller">$</span>
                                ...
                                <div class="pricingtable-inner">
                                    <div class="pricingtable-main">
                                        <div class="pricingtable-price">
                                            ...
                                            <img class="img-fluid w-100" src="{{ asset('images/PLATINUM.png') }}" alt="">
                                            <span>Starting From</span><br>
                                            <div class="text-center">
                                                <span class="priceing-doller">$</span>
                                    ...
                                    <ul class="pricingtable-features">
                                        ...
                                        <li><i class="fa fa-check"></i> Entire Driver's Side (includes doors, fenders, quarter panels)</li>
                                        <li><i class="fa fa-check"></i> Entire Passenger's Side (includes doors, fenders, quarter panels)</li>
                                        <li><i class="fa fa-check"></i> Side View Mirrors</li>
                                        <li><i class="fa fa-check"></i> Headlights and Fog lights</li>
                                        ...
                                        <li><i class="fa fa-check"></i> Full Rear Roof (if separate from the front of the roof)</li>
