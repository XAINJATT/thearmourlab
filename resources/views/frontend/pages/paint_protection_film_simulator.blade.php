    ...
    <div class="page-content bg-white">
                ...
                <div class="col-xl-9">
                    <div class="row">
                        ...
                        <div class="mb-3 col-xl-6">
                            ...
                            <p class="">Our film is crafted from a cutting-edge elastomeric polyurethane that
                                automatically
                                mends minor
                                abrasions
                        ...
                        <div class="mb-3 col-xl-6">
                            <h4 class="text-right"><i class="fas fa-sun mr-2"></i> Resistant to UV-Induced Discolouration
                            </h4>
                            <p class="text-right">The advanced formula of our film is designed to remain transparent and not
                                succumb
                                to yellowing from
                                UV
                        ...
                        <div class="mb-3 col-xl-6">
                            ...
                            <p class="">Bid farewell to worries of imperfections or blemishes from environmental
                                aggressors.
                                Our superior
                                film is
                        ...
                        <div class="mb-3 col-xl-6">
                            ...
                            <p class="text-right">Our film acts as a shield against the everyday road hazards like gravel
                                impacts
                                and surface nicks,
                        ...
                        <div class="mb-3 col-xl-6">
                            <h4 class=""><i class="fas fa-check-circle mr-2"></i> Enhanced Adhesion Edge Technology
                            </h4>
                            <p class="">Our film's innovative Edge Adhesion Technology means edges stay firmly in
                                place,
                                preventing any lift
                                or
        ...
        <section class="section-area bg-white section-sp1">
            <div class="container">
                ...
                <h2 class="text-center">Paint Protection Packages</h2>
                            ...
                            <div class="pricingtable-wrapper style1">
                                <div class="pricingtable-inner">
                                    ...
                                    <ul class="pricingtable-features">
                                        ...
                                        <li><i class="fa fa-check"></i> Entire Driver's Side (includes doors, fenders,
                                            quarter panels)</li>
                                        <li><i class="fa fa-check"></i> Entire Passenger's Side (includes doors, fenders,
                                            quarter panels)</li>
                                        <li><i class="fa fa-check"></i> Side View Mirrors</li>
                                        <li><i class="fa fa-check"></i> Headlights and Fog lights</li>
                                        ...
                                        <li><i class="fa fa-check"></i> Rear Spoiler/Wing (if applicable)</li>
                                        <li><i class="fa fa-check"></i> Full Rear Roof (if separate from the front of the
                                            roof)</li>
                            ...
                            <div class="product-item bg-light mb-4 p-3 pt-5 ">
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <span>Starting From</span>&nbsp;&nbsp; <h5>$150 </h5>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 ">
                            <div class="product-item bg-light mb-4 p-3 pt-5 ">
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <span>( Per side )</span>
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <span>Starting From</span>&nbsp;&nbsp; <h5>$75</h5>
                                        <h6 class="text-muted ml-2"></h6>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center mb-1">
                                        <!-- Average star rating -->
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 ">
                            <div class="product-item bg-light mb-4 p-3 pt-5 ">
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <span>Starting From</span>&nbsp;&nbsp; <h5>$600</h5>
                                        <h6 class="text-muted ml-2"></h6>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center mb-1">
                                        <!-- Average star rating -->
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 ">
                            <div class="product-item bg-light mb-4 p-3 pt-5 ">
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <span>Starting From</span>&nbsp;&nbsp; <h5>$199</h5>
                                        <h6 class="text-muted ml-2"></h6>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center mb-1">
                                        <!-- Average star rating -->
                        ...
                        <div class="item">
                            <div class="portfolio-box style-1">
                                ...
                                <div class="info">
                                    <h5 class="title">
                                        <a href="#">
                                            <i class="flaticon-fuel-1"></i> Paint Protection Film
                                        </a>
                                    </h5>
                                </div>
                            </div>
