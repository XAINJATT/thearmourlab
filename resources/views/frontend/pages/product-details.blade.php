                                                    ...
                                                    <div class="row">
                                                        <div class="large-6 small-12 column left-align">
                                                            ...
                                                            <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <input type="hidden" value="{{ $productDetails->name }}" name="name">
                                                                <input type="hidden" value="{{ $productDetails->discounted_price }}" name="price">
                                                                <input type="hidden" value="{{ $productDetails->product_image }}"  name="image">
