                ...
                <div class="row">
                    <div id="main-container">
                        ...
                        <div class="container mt-5">
                            <div class="header d-flex justify-content-between align-items-center my-5 py-5">
                                <h2>Signature Features</h2>
                                <img class="img-fluid text-right" height="200" style="height:150px !important"
                                    src="{{ asset('images/SCF-SEAL_NonSunscreens-2-color-516x600.jpg') }}" alt="">
                            </div>
                                ...
                                <div class="tint-simulator-auto">
                                    ...
                                    <div id="controls">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="radio" class="tints" name="front"
                                                                id="front70" value="70"><label for="front70"
                                                                class="tintLabel">70</label></td>
                                                        <td><input type="radio" class="tints" name="front"
                                                                id="front50" value="50"><label for="front50"
                                                                class="tintLabel">50</label></td>
                                                        <td><input type="radio" class="tints" name="front"
                                                                id="front35" value="35"><label for="front35"
                                                                class="tintLabel">35</label></td>
                                                        <td><input type="radio" class="tints" name="front"
                                                                id="front20" value="20"><label for="front20"
                                                                class="tintLabel">20</label></td>
                                                        <td><input type="radio" class="tints" name="front"
                                                                id="front05" value="05"><label for="front05"
                                                                class="tintLabel">05</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="middle">Side</td>
                                                        <td><input type="radio" class="tints" name="sides"
                                                                id="sides70" value="70"><label for="sides70"
                                                                class="tintLabel">70</label></td>
                                                        <td><input type="radio" class="tints" name="sides"
                                                                id="sides50" value="50"><label for="sides50"
                                                                class="tintLabel">50</label></td>
                                                        <td><input type="radio" class="tints" name="sides"
                                                                id="sides35" value="35"><label for="sides35"
                                                                class="tintLabel">35</label></td>
                                                        <td><input type="radio" class="tints" name="sides"
                                                                id="sides20" value="20"><label for="sides20"
                                                                class="tintLabel">20</label></td>
                                                        <td><input type="radio" class="tints" name="sides"
                                                                id="sides05" value="05"><label for="sides05"
                                                                class="tintLabel">05</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="middle">Back</td>
                                                        <td><input type="radio" class="tints" name="back"
                                                                id="back70" value="70"><label for="back70"
                                                                class="tintLabel">70</label></td>
                                                        <td><input type="radio" class="tints" name="back"
                                                                id="back50" value="50"><label for="back50"
                                                                class="tintLabel">50</label></td>
                                                        <td><input type="radio" class="tints" name="back"
                                                                id="back35" value="35"><label for="back35"
                                                                class="tintLabel">35</label></td>
                                                        <td><input type="radio" class="tints" name="back"
                                                                id="back20" value="20"><label for="back20"
                                                                class="tintLabel">20</label></td>
                                                        <td><input type="radio" class="tints" name="back"
                                                                id="back05" value="05"><label for="back05"
                                                                class="tintLabel">05</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="windshield">Windshield <sup>*</sup></td>
                                                        <td><input type="radio" class="tints" name="windshield"
                                                                id="windshield80" value="80"><label
                                                                for="windshield80" class="tintLabel">70</label></td>
                                                        <td><input type="radio" class="tints" name="windshield"
                                                                id="windshield70" value="70"><label
                                                                for="windshield70" class="tintLabel">50</label></td>
                                                        <td><input type="radio" class="tints" name="windshield"
                                                                id="windshield50" value="50"><label
                                                                for="windshield50" class="tintLabel">35</label></td>
                                                        <td><input type="radio" class="tints" name="windshield"
                                                                id="windshield50" value="50"><label
                                                                for="windshield50" class="tintLabel">20</label></td>
                                                        <td><input type="radio" class="tints" name="windshield"
                                                                id="windshield50" value="50"><label
                                                                for="windshield50" class="tintLabel">05</label></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="step" id="controlColors">
                                            <h3>Vehicle Color</h3>
                                            <div type="radio" class="colorRadio active" name="black"
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="portfolio-overlay">
                                            <ul>
                                                ...
                                                <li><a href="{{ $image }}"
                                                        class="magnific-anchor ttr-icon"><i
