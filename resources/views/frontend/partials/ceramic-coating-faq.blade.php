    ...
    <div class="row">
        <div class="">
            <div class="ttr-accordion style1" id="themeAccordion1">
                <div class="card">
                    <div class="card-header" id="headingOne" data-bs-toggle="collapse" role="button"
                ...
                <div class="card">
                    <div class="card-header collapsed" id="headingTwo" role="button" data-bs-toggle="collapse"
                ...
                <div class="card">
                    <div class="card-header collapsed" id="headingThree" role="button" data-bs-toggle="collapse"
                ...
                <div class="card">
                    <div class="card-header collapsed" id="headingFour" role="button" data-bs-toggle="collapse"
                ...
                <div class="card">
                    <div class="card-header collapsed" id="headingFive" role="button" data-bs-toggle="collapse"
