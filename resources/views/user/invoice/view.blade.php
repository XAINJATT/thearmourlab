            ...
            <form method="post" action="{{ route('admin.invoice.store') }}" enctype="multipart/form-data">
              ...
              <div class="row py-sm-3">
                <div class="col-md-4 col-12">
                  ...
                  <input type="text" class="form-control" id="email" name="email" value="{{ @$order->user->email }}" disabled />
                </div>
                <div class="col-md-4 col-12">
                  <label for="first_name" class="form-label me-5 fw-medium">First Name:</label>
                  <input type="text" class="form-control" id="first_name" name="first_name" value="{{ @$order->user->first_name }}" disabled />
                </div>
                <div class="col-md-4 col-12">
                  <label for="last_name" class="form-label me-5 fw-medium">Last Name:</label>
                  <input type="text" class="form-control" id="last_name" name="last_name" value="{{ @$order->user->last_name }}" disabled />
                </div>
                <div class="col-md-4 col-12 mt-2">
                  <label for="phone" class="form-label me-5 fw-medium">Phone:</label>
                  <input type="text" class="form-control" id="phone" name="phone" value="{{ @$order->user->phone }}" disabled />
                </div>
                <div class="col-md-4 col-12">
                  <label for="make" class="form-label me-5 fw-medium">Make:</label>
                  <input type="text" class="form-control" id="make" name="make" value="{{ @$order->make }}" disabled />
                </div>
                <div class="col-md-4 col-12">
                  <label for="colour" class="form-label me-5 fw-medium">Colour:</label>
                  <input type="text" class="form-control" id="colour" name="colour" value="{{ @$order->colour }}" disabled />
                </div>
                <div class="col-md-4 col-12 mt-2">
                  <label for="model" class="form-label me-5 fw-medium">Model:</label>
                  <input type="text" class="form-control" id="model" name="model" value="{{ @$order->model }}" disabled />
                </div>
                <div class="col-md-4 col-12 mt-2">
                  <label for="year" class="form-label me-5 fw-medium">Year:</label>
                  <input type="text" class="form-control" id="year" name="year" value="{{ @$order->year }}" disabled />
                </div>
                <div class="col-md-4 col-12 mt-2">
                  <label for="v_i_n" class="form-label me-5 fw-medium">V.I.N#:</label>
                  <input type="text" class="form-control" id="v_i_n" name="v_i_n" value="{{ @$order->v_i_n }}" disabled />
                </div>
                <div class="col-md-4 col-12 mt-2">
                  <label for="plate" class="form-label me-5 fw-medium">Plate#:</label>
                  <input type="text" class="form-control" id="plate" name="plate" value="{{ @$order->plate }}" disabled />
                </div>
                <div class="col-md-4 col-12 mt-2">
              ...
              <div class="row p-sm-3 p-0">
                <div class="col-lg-4 col-12 invoice-actions">
                    ...
                    <div class="card-body">
                      <div class="d-flex justify-content-between mb-2">
                        ...
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="kenzo_coating" name="ceramic_coating_kenzo_coating" value="1" {{ @$order->ceramic_coating_kenzo_coating ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between mb-2">
                        <label for="quartz_plus_coating" class="mb-0">Quartz Plus Coating</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="quartz_plus_coating" name="ceramic_coating_quartz_plus_coating" value="1" {{ @$order->ceramic_coating_quartz_plus_coating ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between mb-2">
                        <label for="quartz_coating" class="mb-0">Quartz Coating</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="quartz_coating" name="ceramic_coating_quartz_coating" value="1" {{ @$order->ceramic_coating_quartz_coating ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between mb-2">
                        <label for="premier_coating" class="mb-0">Premier Coating</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="premier_coating" name="ceramic_coating_premier_coating" value="1" {{ @$order->ceramic_coating_premier_coating ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between mb-2">
                        <label for="interior_pkg" class="mb-0">Interior PKG</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="interior_pkg" name="ceramic_coating_interior_pkg" value="1" {{ @$order->ceramic_coating_interior_pkg ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between">
                        <label for="wheels_of_pkg" class="mb-0">Wheels of PKG</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="wheels_of_pkg" name="ceramic_coating_wheels_of_pkg" value="1" {{ @$order->ceramic_coating_wheels_of_pkg ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                    </div>
                  </div>
                  <div class="">
                    ...
                    <div class="">
                      <input type="number" class="form-control" name="ceramic_coating_price" value="{{ @$order->ceramic_coating_price }}" disabled>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-12 invoice-actions">
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      <div class="d-flex justify-content-between mb-2">
                        ...
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="full_car" name="ppf_full_car" value="1" {{ @$order->ppf_full_car ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between mb-2">
                        <label for="client-notes" class="mb-0">Client Notes</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="client-notes" name="ppf_client_notes" value="1" {{ @$order->ppf_client_notes ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between mb-2">
                        <label for="payment-stub" class="mb-0">Payment Stub</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="payment-stub" name="ppf_payment_stub" value="1" {{ @$order->ppf_payment_stub ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between mb-2">
                        <label for="payment-terms" class="mb-0">Payment Terms</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" id="payment-terms" name="ppf_payment_terms" value="1" {{ @$order->ppf_payment_terms ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-4 col-12 invoice-actions">
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      <div class="d-flex justify-content-between mb-2">
                        <label for="payment-terms" class="mb-0">Payment Terms</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" name="cc_payment_terms" {{ @$order->cc_payment_terms ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between mb-2">
                        <label for="client-notes" class="mb-0">Client Notes</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" name="cc_client_notes" {{ @$order->cc_client_notes ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                      <div class="d-flex justify-content-between">
                        <label for="payment-stub" class="mb-0">Payment Stub</label>
                        <label class="switch switch-primary me-0">
                          <input type="checkbox" class="switch-input" name="cc_payment_stub" {{ @$order->cc_payment_stub ? 'checked' : '' }} disabled>
                        </label>
                      </div>
                    </div>
                  </div>
                  <div class="">
                    <label for="price" class="mb-0">Price :</label>
                    <div class="">
                      <input type="number" class="form-control" name="cc_price" value="{{ @$order->cc_price }}" disabled>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" rows="2" id="additional_requests" name="additional_requests" placeholder="Additional Requests" disabled>{{ @$order->additional_requests }}</textarea>
                  </div>
                </div>
                <div class="col-6 mb-3">
                  <label for="total_price" class="mb-0">Total Price :</label>
                  <div class="">
                    <input type="number" class="form-control" id="total_price" name="total_price" value="{{ @$order->total_price }}" disabled>
                  </div>
                </div>
                <div class="col-12 col-md-6 col-6 mb-3">
                  ...
                  <img src="{{ $order->drivers_license }}" alt="drivers_license" class="picture-src" id="drivers_license_preview" width="80%" height="60%">
                </div>
              </div>
                ...
                <div class="col-md-8 col-sm-7">
                  <div class="row">
                    ...
                    <div class="col-5">
                      ...
                      <div class="">
                        <input type="number" class="form-control" id="mileage_in_price" value="{{ @$order->mileage_in_price }}" disabled>
                      </div>
                    </div>
                  </div>
                  <img src="{{ @$order->defects }}" id="defects" alt="Preview" width="80%" height="60%" />
                </div>
              </div>
              <hr class="my-4" />
              <!-- Note Start -->
              <div class="row">
                ...
                <div class="col-6 mb-3">
                  ...
                  <div class="">
                    <input type="number" class="form-control" id="int" name="int" value="{{ @$order->int }}" disabled>
                  </div>
                </div>
              </div>
              <!-- Note End -->
              ...
              <div class="row">
                ...
                <div class="col-6">
                  ...
                  <input type="text" class="form-control" id="payment_type" name="payment_type" value="{{ @$order->payment_type }}" disabled>
                </div>
              </div>
              <hr class="my-4" />
              <div class="row">
                  ...
                  <div class="border p-3">
                    ...
                    <div class="row mt-3">
                      ...
                      <div class="col-5">
                        ...
                        <div class="">
                          <input type="date" class="form-control" id="date" name="date" value="{{ @$order->date }}" disabled>
                        </div>
                      </div>
                    </div>
                  </div>
