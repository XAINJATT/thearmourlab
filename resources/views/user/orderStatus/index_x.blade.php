    ...
    <div class="row invoice-add">
      ...
      <div class="container padding-bottom-3x mb-1">
        ...
        <!-- <div class="d-flex flex-wrap flex-md-nowrap justify-content-center justify-content-sm-between align-items-center mb-3">
          ...
          <div class="text-left text-sm-right"><a class="btn btn-outline-primary btn-rounded btn-sm" href="{{ route('user.orderStatus') }}" data-toggle="modal" data-target="#orderDetails">View Order Details</a></div>
        </div> -->
        <div class="col-md-12 col-12 col-sm-12">
          <div class="card">
            <div class="card-header">
